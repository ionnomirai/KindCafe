...
import com.example.kindcafe.databinding.FragGeneralSettingsBinding
...
class SettingsGeneralFragment: Fragment() {
    /*---------------------------------------- Properties ----------------------------------------*/
    private var _binding: FragGeneralSettingsBinding? = null
    private val binding
        get() : FragGeneralSettingsBinding {
    ...
    override fun onCreateView(
        ...
        _binding = FragGeneralSettingsBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
